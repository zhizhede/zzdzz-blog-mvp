...
<template>
  <div class="page-container">
    <div class="toolbar">
      <h2>我的笔记</h2>
      <el-button type="primary" @click="router.push('/space/notes/new')">
        <el-icon><Plus /></el-icon>写新笔记
      </el-button>
    </div>
    ...
    <el-card>
      ...
      <el-table :data="list" v-loading="loading" stripe>
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default="{ row }">
            <el-button text type="primary" @click="router.push(`/space/notes/${row.id}/edit`)">编辑</el-button>
